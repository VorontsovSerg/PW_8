...
public class TaskWorker extends Worker {
    ...
    public Result doWork() {
        ...
        String startMessage = "Начало выполнения последовательной задачи. " + randomNumber;

        showToast(startMessage);

        String endMessage = "Завершение выполнения последовательной задачи. " + randomNumber;
